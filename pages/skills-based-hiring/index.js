    ...
    {/* Banner */}
        ...
        <div className="container mx-auto">
          <div className="relative flex flex-col items-center sm:static lg:flex-row">
            <div className="mb-16 mt-4 flex flex-col items-center text-center md:mb-0 md:w-full md:items-center md:px-[0px] md:py-[32px] md:text-left lg:mt-24 lg:flex-grow lg:items-start lg:pr-24">
              ...
              <p className="caption-regular-3 sm:caption-regular-1 mb-6 mt-0 text-center lg:text-start">
                New for October 2023: The world's only report on the State of Skills-Based Hiring. Out now!                     </p>
            ...
            <div className={`${styles.content_wrapper}`}>
                ...
                <div className={`${styles.topicsIcon_wrapper}`}>
                    <div className={`${styles.topic_single}`}>
                        <Image src="/assets/FAQ Icon_x40.png" width={60} height={60} alt="Icon Topics FAQ" />
      ...
      <section className={`${styles.section_grey}`}>
        <div className={`container mx-auto`}>
            <div className={`${styles.content_wrapper}`}>
                <h2>Browse Topics</h2>
                <p>Our data shows extraordinary outcomes for employers and candidates</p>
                <div className={`${styles.topicsIcon_wrapper}`}>
                    <div className={`${styles.topic_single}`}>
                    ...
                    <div className={`${styles.topic_single}`}>
                        ...
                        <p>of employees say skills-based hiring can help them land their dream job</p>
                    </div>
                    <div className={`${styles.topic_single}`}>
        ...
        <div className="container mx-auto">
          <div className="relative flex flex-col items-center sm:static lg:flex-row">
            <div className="mb-16 mt-4 flex flex-col items-center text-center md:mb-0 md:w-full md:items-center md:px-[0px] md:py-[32px] md:text-left lg:mt-24 lg:flex-grow lg:items-start lg:pr-24">
              ...
              <p className="caption-regular-3 sm:caption-regular-1 mb-6 mt-0 text-center lg:text-start">
              Recruitment is changing fast. Over the past year we’ve seen the red-hot candidate market give way to recessionary fears, and the rise of AI-based tools that promise a brand-new world of work. As businesses reshape their workforces to deal with these challenges, <span>skills-based hiring has emerged as the preferred tool to find and secure talent</span>.
              </p>
              <p className="caption-regular-3 sm:caption-regular-1 mb-6 mt-0 text-center lg:text-start">
              In <span>the world's only annual report on skills-based hiring</span>, we deep dive into the revolutionary recruitment trend to find out how employers are leveraging this approach, how it’s affecting candidate experience in the current job market, and what the adoption of skills-based hiring practices means for diversity efforts across organizations.
              </p>
              <div className="mb-6 flex justify-center">
